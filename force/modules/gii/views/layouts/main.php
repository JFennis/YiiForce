...
<div class="container" id="page">
	<div id="header">
		...
		<?php echo CHtml::link('force',yii::app()->baseUrl.'/index.php/force'); ?> |	<a href="http://www.yiiframework.com">yii</a>
		<?php if(!Yii::app()->user->isGuest): ?> | <?php echo CHtml::link('logout',array('default/logout')); ?>
		<?php endif; ?>
		</div>
