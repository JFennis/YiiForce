...
Yii::import('force.modules.gii.CCodeGenerator');
Yii::import('force.modules.gii.CCodeModel');
Yii::import('force.modules.gii.CCodeFile');
Yii::import('force.modules.gii.CCodeForm');
 ...
 * @since 1.1.2
 */
class GiiModuleForce extends CWebModule
{
	/**
	...
	public function init()
	{
		...
		$this->generatorPaths[] = 'force.modules.gii.generators';
